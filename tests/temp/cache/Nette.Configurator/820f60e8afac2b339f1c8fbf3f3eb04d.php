<?php
// source: /var/www/zenify/TitleComponent/tests/config/default.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'zenify\\titlecomponent\\titlecontrolfactory' => array('0.flashMessageFactory'),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/var/www/zenify/TitleComponent/tests',
			'wwwDir' => '/var/www/zenify/TitleComponent/vendor/phpunit/phpunit',
			'debugMode' => FALSE,
			'productionMode' => TRUE,
			...
			'tempDir' => '/var/www/zenify/TitleComponent/tests/temp/',
		));
	}


	/**
	 * @return Zenify\TitleComponent\TitleControlFactory
	 */
	public function createService__0__flashMessageFactory()
	{
		return new SystemContainer_Zenify_TitleComponent_TitleControlFactoryImpl_0_flashMessageFactory($this);
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/zenify/TitleComponent/tests/temp//cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/var/www/zenify/TitleComponent/tests/temp/');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('/var/www/zenify/TitleComponent/tests/temp//cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('/var/www/zenify/TitleComponent/tests', $this);
		return $service;
	}
...
final class SystemContainer_Zenify_TitleComponent_TitleControlFactoryImpl_0_flashMessageFactory implements Zenify\TitleComponent\TitleControlFactory
{
	...
	{
		$service = new Zenify\TitleComponent\TitleControl;
		return $service;
	}
